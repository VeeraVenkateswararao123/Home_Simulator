...
const Model5 = () => {
  ...
  return (
    <div className="main">
      <div>
        <h2 className="main_heading">Customize Residenal House Model</h2>
        <div className="row">
              ...
              <Canvas style={{ width: "100%", height: "100vh" }}>
                ...
                <Bounds fit clip margin={3}>
                  <DynamicMaterialModel
                    modelPath="https://ssvconstructions.in/wp-content/uploads/2025/01/glb_files/small_residental_house.glb"
